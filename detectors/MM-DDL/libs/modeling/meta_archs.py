...
class PtTransformer(nn.Module):
    ...
    def label_points_single_video(self, concat_points, gt_segment, gt_label):
        ...
        if num_gts == 0:
            ...
            # print("class:", cls_targets.shape)
            # print("reg:", reg_targets.shape)
    ...
    def losses(
        ...
        final_loss = 0.01*cls_loss + reg_loss * loss_weight
        # loss_weight = 0.1
...
# 'val_data/fake_audio_real_visual/cf1f6b22537e525de305448f7be5516a.mp4'